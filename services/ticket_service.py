...
class TicketService:
    ...
    @classmethod
    def search_tickets(clazz, params: SearchParams):
        """查询车票信息
        ...
        Returns:
            车票查询结果的 JSON 数据
        """
        response: Response = SessionManager.get_session().get(url='https://kyfw.12306.cn/otn/leftTicket/queryG', params = params.get_params())
        try:
            arr = []
